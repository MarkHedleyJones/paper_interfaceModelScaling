...
% No sadly not interesting just related to the fact that interface has its own internal resitance.
    No response yet.
}\\
...
{\color{OliveGreen}
    Item 25\\
% Because consistent with prev pub plus it doesnt matter which STRESS THIS.
