...
{
    \color{blue}
    Transimpedance measurements in-vivo were done using additional configurations than were carried out in section \ref{sect:resistorNetwork}. The same measurements were captured but a more complete stimulus--measure regieme was tried in order to minimise the effect of nearby bone having too large an effect on a small number of measurements.
}
\begin{table}
...
\begin{figure}
    \begin{center}
        \includegraphics{graphics/sheep_transimpedance}
    \end{center}
    \caption{Comparison between in-vivo transresistance measurements (blue dots) and simulation results using fitted mesh parameters (red trace).}
    \label{fig:transimpedance_sheep}
\end{figure}
