...
=======
    This has been reworded to convey that the shift in the CPE response is small relative to the shift in the resistance in the solution bulk. We are referring to a relative difference, a gain in conductivity as a factor of the current conductivity.
>>>>>>> da6de38179e123424f7e9dcc3e1679e77489e125
}\\
...
{\color{OliveGreen}
    With respect to the comment on poor attention to detail and innaccurate use of words, we have revised the manuscript to include more detail both in regards to experimental setup, the electrochemistry and model elements. We have chosen to mix the discussion with results as the model parameters are derived along with the measurments, which are required before moving to each subsiquent step.
}\\
...
{\color{OliveGreen}
    We have added maximum and minimum current density calculations, peak stimulus voltage information and added a plot showing the amount of charge injected during measurment of displacement currents.
}\\
...
{\color{OliveGreen}
    The caption in Figure 4 has been reworded to more accurately describe the situation. Yes this graph is showing the CPE in series with both the inter-electrode resistance and $R_{S}$.
}\\
...
{\color{OliveGreen} 
    The requirement of $R_{S}$ has been clarified at the end of Section II. This was not made very clear in our original submission, thank you for pointing this out.
}\\

6. P2, col 2, line 24: why 2 \& 7?\\
{\color{OliveGreen}
    The choice of electrodes was arbitrary. We felt that electrodes 2 and 7 were a good compromise between good separation and avoiding any end effects. This was the same pair as used by Scott \& Single 2013 from which we have based our measurements.
}\\
...
{\color{OliveGreen}
    We have cleaned this statement up. See end of section III.
}\\
...
{\color{OliveGreen} 
    That is correct. This equation is the standard diode equation found in any electronic engineering textbook.
}\\

9. P3, col 2, line 31: why 2 and 6?\\
{\color{OliveGreen}
    Again a totally arbitrary choice, we fit the model to whichever pair we use. We actually used electrodes 7 and 3, the mention of electrodes 2 and 6 was a mistake. Thank you for bringing that to our attention. 
}\\
...
{\color{OliveGreen}
    Item 33\\
% We can dial up shift in cpe and bulk resistance to create a better match using available chemical reagenre. we hope to synth a superior phantom through combos of saline solvets and hydrolysed cellulose. we anticipate crateing a superios phantom using. one of the goals of one of our industrial partners.
...
{\color{OliveGreen}
    Item 35\\
% No reference elect possible in an implated scenario. Much of problem stems fro trad. electchem are inepplicable or impodssible. much or ou rreviewers arises fro fact that we are operating ni  an scenario far fro trad electrochem labs.
...
{\color{OliveGreen}
    Item 36\\
% In response to numersios reviewese commnets we have added citations we hope we have more thoroughly put more thoro pointers to the literature in  nour manuscript...  After extensice ... we have added citations
