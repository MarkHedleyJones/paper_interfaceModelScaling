...
It has been suggested that the primary coupling mechanism between platinum electrodes and phisiological saline is the reversable evolution of gas, probably oxygen, at the platinum surface, which dissolves without bubble formation.\cite{Greatbatch1969} Understanding exact mechanism of displacement or Faradaic charge transfer at the electrode surface is beyond the scope of this work, instead we wish to characterise the electrode/electrolyte system in terms of an electrical model. The model separates the Faradaic and displacement characteristics into separate circuit elements, namely the diode and CPE, however we do not suggest that these conduction mechanisims are physically separate.
